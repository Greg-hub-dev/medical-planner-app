...
const fr: Dict = {
  ...
  'method.title': 'Méthode de révision',
  'method.hint': "Choisissez un rythme d'espacement, ou personnalisez les intervalles (en jours).",
  'method.preset': 'Modèle',
  'method.custom': 'Personnalisé',
  'method.j': 'Méthode des J (défaut)',
  'method.leitner': 'Classique / Leitner',
  'method.doubling': 'Intervalles doublants',
  'method.intensive': 'Intensif (examen proche)',
  'method.anki': 'Type Anki (SM-2)',
  'method.intervals': 'Intervalles (jours)',
  'method.addInterval': 'Intervalle',
  'method.save': 'Enregistrer la méthode',
  'method.saved': '✅ Méthode enregistrée (appliquée aux nouveaux cours).',
  'method.nochange': 'Aucun changement à enregistrer.',
  'method.applyQ': 'Des cours existent déjà. Appliquer la nouvelle méthode :',
  'method.applyNew': 'Nouveaux cours uniquement',
  'method.applyExisting': 'Aussi aux cours existants',
  'method.applied': '✅ Méthode appliquée à {n} cours (progression conservée par intervalle).',
...
const en: Dict = {
  ...
  'method.title': 'Revision method',
  'method.hint': 'Pick a spacing rhythm, or customise the intervals (in days).',
  'method.preset': 'Preset',
  'method.custom': 'Custom',
  'method.j': 'J-method (default)',
  'method.leitner': 'Classic / Leitner',
  'method.doubling': 'Doubling intervals',
  'method.intensive': 'Intensive (exam soon)',
  'method.anki': 'Anki-style (SM-2)',
  'method.intervals': 'Intervals (days)',
  'method.addInterval': 'Interval',
  'method.save': 'Save method',
  'method.saved': '✅ Method saved (applied to new courses).',
  'method.nochange': 'No change to save.',
  'method.applyQ': 'You already have courses. Apply the new method:',
  'method.applyNew': 'New courses only',
  'method.applyExisting': 'Also existing courses',
  'method.applied': '✅ Method applied to {n} courses (progress kept per interval).',
